...
export default function DataManagementPage({}: DataManagementPageProps) {
  ...
  // Fetch operators on mount (needed for edit modals regardless of tab)
  const fetchOperators = async () => {
    try {
      ...
      console.error('Error fetching operators for dropdowns:', error)
    }
  }
  ...
  useEffect(() => {
    fetchTotalCounts()
    fetchOperators() // Load operators for dropdowns
  }, [])
