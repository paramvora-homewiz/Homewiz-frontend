...
import RealAnalyticsDashboard from '../dashboard/RealAnalyticsDashboard'
...
import { ErrorToastProvider } from '../providers/error-toast-provider'
import {
  Users,
  Building,
  Home,
...
function FormsDashboardContent() {
  ...
  const handleFormSubmit = async (data: any, formType: FormType) => {
    ...
    try {
      ...
      // Always use Supabase form integration for forms (backend API endpoints don't work)
      // Backend is only enabled for chat WebSocket functionality
      console.log('🔧 Using Supabase form integration (direct database connection)')
      let result
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
        <div className="max-w-7xl mx-auto p-6 space-y-8">
          ...
          <motion.div
            ...
            className="bg-gradient-to-r from-emerald-500 via-blue-500 to-purple-500 rounded-2xl p-6 mb-8 shadow-2xl"
          >
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white/90 text-sm">Experience all features without signing up. Your data is safe!</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <div className="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-lg text-white text-sm font-semibold">
