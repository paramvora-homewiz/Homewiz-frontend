...
import EnhancedAnalyticsDisplay from './analytics/EnhancedAnalyticsDisplay';
import { 
...
export default function InteractiveMessageRenderer({ content, data, metadata, onAction }: InteractiveMessageProps) {
  ...
  const renderAnalyticsReport = () => {
    ...
    // Use the enhanced analytics display component
    return <EnhancedAnalyticsDisplay data={data} content={content} />;
  };
